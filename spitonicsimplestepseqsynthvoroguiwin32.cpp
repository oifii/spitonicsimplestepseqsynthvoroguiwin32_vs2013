...
#include "stdafx.h"
#include "spitonicsimplestepseqsynthvoroguiwin32.h"
#include "FreeImage.h"
...
TCHAR szTitle[1024]={L"spitonicsimplestepseqsynthvoroguiwin32title"};					// The title bar text
TCHAR szWindowClass[1024]={L"spitonicsimplestepseqsynthvoroguiwin32class"};				// the main window class name
